...
** Jigasi
We need configure a SIP gateway in .env file
#+begin_example
...
*** Configure Jibri
Uncomment this lines in .env file
#+begin_example
ENABLE_RECORDING=1
...
NOTE: you need a real domain with valid ssl for https and rename all 'meet.jitsi' to your domain name or disable https in .env file
